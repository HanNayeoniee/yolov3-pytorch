...
#                 print('loss_bbox_{}'.format(i + 1), yolo_layer.metrics['loss_bbox'])
#                 print('loss_conf_{}'.format(i + 1), yolo_layer.metrics['loss_conf'])
#                 print('loss_cls_{}'.format(i + 1), yolo_layer.metrics['loss_cls'])
#                 print('loss_layer_{}'.format(i + 1), yolo_layer.metrics['loss_layer'])
...
#         torch.save(model.state_dict(), os.path.join(save_dir, 'yolov3_{}.pth'.format(dataset_name)))
