...
if __name__ == "__main__":
    ...
    #                     help="path to pretrained weights file")  # 원래 코드
    # parser.add_argument("--pretrained_weights", type=str, default="weights/yolov3.weights",
    #                     help="path to pretrained weights file")  # 다운받은 가중치 사용
    parser.add_argument("--pretrained_weights", type=str, default="checkpoints/210218_143324/yolov3_coco_9.pth",
                        help="path to pretrained weights file")  # 내가 학습시켜서 만든 가중치 사용
